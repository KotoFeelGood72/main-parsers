const { createSharraiParser } = require('./SharraiParser');
...
/**
 * Создание модуля парсера Sharrai (функциональный стиль)
 */
function createSharraiModule() {
    ...
    async function initialize() {
        try {
            ...
            state.parser = createSharraiParser(config);
...
module.exports = { createSharraiModule, SharraiModule: createSharraiModule };
