...
/**
 * Создание парсера OneClickDrive (функциональный стиль)
 */
function createOneclickdriveParser(config = {}) {
    const parserConfig = {
...
module.exports = { createOneclickdriveParser, OneclickdriveParser: createOneclickdriveParser };
