...
/**
 * Создание парсера AutoTraders (функциональный стиль)
 */
function createAutotradersParser(config = {}) {
    const parserConfig = {
...
module.exports = { createAutotradersParser, AutotradersParser: createAutotradersParser };
