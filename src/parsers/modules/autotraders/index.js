const { createAutotradersParser } = require('./AutotradersParser');
...
/**
 * Создание модуля парсера AutoTraders (функциональный стиль)
 */
function createAutotradersModule() {
    ...
    async function initialize() {
        try {
            ...
            state.parser = createAutotradersParser(config);
...
module.exports = { createAutotradersModule, AutotradersModule: createAutotradersModule };
