const { createCarswitchParser } = require('./CarswitchParser');
...
/**
 * Создание модуля парсера Carswitch (функциональный стиль)
 */
function createCarswitchModule() {
    const config = createModuleConfig({
        name: 'carswitch',
        displayName: 'Carswitch',
    ...
    async function initialize() {
        try {
            ...
            state.parser = createCarswitchParser(config);
...
module.exports = { createCarswitchModule, CarswitchModule: createCarswitchModule };
