...
/**
 * Создание парсера Dubizzle (функциональный стиль)
 */
function createDubizzleParser(config = {}) {
    const parserConfig = {
...
module.exports = { createDubizzleParser, DubizzleParser: createDubizzleParser };
