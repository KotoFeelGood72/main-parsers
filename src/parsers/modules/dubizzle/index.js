const { createDubizzleParser } = require('./DubizzleParser');
...
/**
 * Создание модуля парсера Dubizzle (функциональный стиль)
 */
function createDubizzleModule() {
    ...
    async function initialize() {
        try {
            ...
            state.parser = createDubizzleParser(config);
...
module.exports = { createDubizzleModule, DubizzleModule: createDubizzleModule };
